    ...
    <div className='container'>
      ...
      <form className='row g-3'>
        ...
        <div className='col-md-5'>
          ...
          <input type='text' name='ciaTer' className='form-control' id='cia-tercero' required />
        </div>
        <div className='col-md-5'>
          <label htmlFor='cobertura-tercero' className='form-label'>Cobertura</label>
          <input type='text' name='coberturaTer' className='form-control' id='cobertura-tercero' required />
        </div>
        <div className='col-md-5'>
          <label htmlFor='poliza-tercero' className='form-label'>Poliza de seguros</label>
          <input type='text' name='polizaTer' className='form-control' id='poliza-tercero' required />
        </div>
        <hr/>
        <div className='col-md-3'>
          <label htmlFor='numero-siniestro' className='form-label'>Número de siniestro</label>
          <input type='text' name='siniestroTer' className='form-control' id='numero-siniestro' required />
        </div>
        <div className='col-md-3'>
          <label htmlFor='numero-denuncia' className='form-label'>Número de denuncia</label>
          <input type='text' name='denunciaTer' className='form-control' id='numero-denuncia' required />
        </div>
        <hr/>
        <div className='col-md-5'>
          <label htmlFor='nombre-tercero' className='form-label'>Nombre</label>
          <input type='text' name='nombreTer' className='form-control' id='nombre-tercero' required />
        </div>
        <div className='col-md-5'>
          <label htmlFor='apellido-tercero' className='form-label'>Apellido</label>
          <input type='text' name='apellidoTer' className='form-control' id='apellido-tercero' required />
        </div>
        <div className='col-md-3'>
          <label htmlFor='documento-tercero' className='form-label'>Documento</label>
          <input type='text' name='documentoTer' className='form-control' id='documento-tercero' required />
        </div>
        <div className='col-md-3'>
          <label htmlFor='domicilio-tercero' className='form-label'>Domicilio</label>
          <input type='text' name='domicilioTer' className='form-control' id='domicilio-tercero' required />
        </div>
        <div className='col-md-3'>
          <label htmlFor='telefono-tercero' className='form-label'>Telefono de contacto</label>
          <input type='number' name='telefonoTer' className='form-control' id='telefono-tercero' required />
        ...
        <div className='col-md-5'>
          ...
          <input type='text' name='marcaTer' className='form-control' id='marca-tercero' required />
        </div>
        <div className='col-md-5'>
          <label htmlFor='modelo-tercero' className='form-label'>Modelo del vehiculo</label>
          <input type='text' name='modeloTer' className='form-control' id='modelo-tercero' required />
        </div>
        <hr/>
        <div>
        ...
        <div className='col-md-5'>
          ...
          <input type='text' name='nombreSol' className='form-control' id='nombre-solicitante' required />
        </div>
        <div className='col-md-5'>
          <label htmlFor='apellido-solicitante' className='form-label'>Apellido</label>
          <input type='text' name='apellidoSol' className='form-control' id='apellido-solicitante' required />
        </div>
        <div className='col-md-3'>
          <label htmlFor='documento-solicitante' className='form-label'>Documento</label>
          <input type='text' name='documentoSol' className='form-control' id='documento-solicitante' required />
        </div>
        <div className='col-md-3'>
          <label htmlFor='domicilio-solicitante' className='form-label'>Domicilio</label>
          <input type='text' name='domicilioSol' className='form-control' id='domicilio-solicitante' required />
        </div>
        <div className='col-md-3'>
          <label htmlFor='telefono-solicitante' className='form-label'>Telefono de contacto</label>
          <input type='number' name='telefonoSol' className='form-control' id='telefono-solicitante' required />
          <span id="tel" className="form-text">Con código de área sin el 0 ni el 15. Ej: 3813999999</span>
        </div>
        <div className='col-md-5'>
          <label htmlFor='cia-solicitante' className='form-label'>Compañia de seguro</label>
          <input type='text' name='ciaSol' className='form-control' id='cia-solicitante' required />
        </div>
        <div className='col-md-5'>
          <label htmlFor='cobertura-solicitante' className='form-label'>Cobertura</label>
          <input type='text' name='coberturaSol' className='form-control' id='cobertura-solicitante' required />
        </div>
        <div className='col-md-5'>
          <label htmlFor='poliza-solicitante' className='form-label'>Poliza de seguros</label>
          <input type='text' name='polizaSol' className='form-control' id='poliza-solicitante' required />
        </div>
        <hr/>
        <div className='col-md-7 me-md-3'>
          <label htmlFor='comentario' className='form-label'>Cuentanos lo sucedido</label>
          <textarea className='form-control' name='comentarios' id='comentario' rows='3' required></textarea>
        </div>
